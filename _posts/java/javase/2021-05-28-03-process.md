...
- ![image](/images/posts/java/javase/03-process/process.png)
...
- ![image](/images/posts/java/javase/03-process/if-single-branch.png)


## 双分支
- 当条件表达式为真时，执行语句块1
- 否则，执行语句块2，也就是else部分。
- ![image](/images/posts/java/javase/03-process/if-double-branch.png)
...
- ![image](/images/posts/java/javase/03-process/while-loop.png)
- ```java
...
- while
	- 先判断，后执行。
	- ![image](/images/posts/java/javase/03-process/do-while.png)
	- ```java
		int a = 0;
		do {
...
- break：改变程序控制流
	...
	- ![image](/images/posts/java/javase/03-process/break.png)
- 什么是continue语句
- continue ：只能用在循环里
- continue 作用：跳过循环体中剩余的语句而执行下一次循环
- ![image](/images/posts/java/javase/03-process/continue.png)
- 对比break和continue
- 使用场合
...
- ![image](/images/posts/java/javase/03-process/multiple-loop.png)
